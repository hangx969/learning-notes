...
- 解决：
  ...
  参考文档：[StackOverflow - After uninstalling calico, new pods are stuck in container creating state](https://stackoverflow.com/questions/61672804/after-uninstalling-calico-new-pods-are-stuck-in-container-creating-state)
