...
> [!info] k8s <= 1.23装istio 1.10/1.13即可；k8s >= 1.24装1.18+
...
> [!info] 此时有两个版本的pod都是apply: canary标签，这个svc代理了两个pod，默认是采用轮询方式，curl svc-ip时会轮流代理给v1和v2两个pod
