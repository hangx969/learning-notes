...
| K8S集群角色 | IP            | 主机名 |
| ----------- | ------------- | ------ |
| 控制节点    | 172.16.183.90 | rm1    |
| 工作节点    | 172.16.183.91 | rn1    |
...
> nmcli connection modify ens160 ipv4.addresses 172.16.183.90/24 #修改IP地址和掩码
...
localAPIEndpoint:
  advertiseAddress: 172.16.183.90 #控制节点的ip
  bindPort: 6443
nodeRegistration:
