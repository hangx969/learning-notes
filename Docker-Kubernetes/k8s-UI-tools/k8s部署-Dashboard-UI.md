...
> 也可以直接获取一次性token（有有效期），在dashboard界面输入
>
> ~~~sh
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: kubernetes-dashboard
          image: registry.cn-beijing.aliyuncs.com/dotbalo/dashboard:v2.7.0
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: dashboard-metrics-scraper
          image: registry.cn-beijing.aliyuncs.com/dotbalo/metrics-scraper:v1.0.8
          ports:
            - containerPort: 8000
              protocol: TCP
          livenessProbe:
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        image: registry.cn-beijing.aliyuncs.com/dotbalo/metrics-server:v0.7.2
