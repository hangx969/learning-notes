...
[阿里云CentOS停服替代方案](https://help.aliyun.com/zh/ecs/user-guide/options-for-dealing-with-centos-linux-end-of-life)
...
#    Rocky Linux 使用 BLS（Boot Loader Specification），内核启动参数存储在
