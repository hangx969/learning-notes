...
- 在repo的根目录下一般会有==azure-pipelines.yml==，一般会定义如下内容：
  - 什么情况下触发trigger
...
- pipeline中的job不支持priority，而是通过==condition==和==dependency==来实现
...
> [!important]
> ado中，下列资源属于==protected resources==，每项资源都可以单独被管理，需要user账户被加到Admin Group中：
> - Agent pools
