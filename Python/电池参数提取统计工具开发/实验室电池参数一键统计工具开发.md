...
> [!tip] V2.0~V4.0 改进内容
> - ==V2.0==: 文件名自动加日期、参数转为float格式、嵌套字典直接赋值Excel、按文件名排序
> - ==V3.0==: 添加 ==tkinter== 可视化窗口
> - ==V4.0==: 优化窗口外观、添加使用说明、重构为面向对象编程
>
...
适配另一种输出格式的电池测试软件,使用 ==pandas== 读取csv文件中的电池参数
