...
历经 4 个月， <u>派聪明 RAG 知识库项目 </u>终于完工（包括源码和教程，全部交付给大家）！
...
了解技术派的球友应该知道，派聪明最初是 [<u>技术派实战项目 </u>](https://javabetter.cn/zhishixingqiu/paicoding.html)中一部分，主打的服务是和 AI 大模型进行聊天对话（没有检索增强生成）。
...
可以续费的球友，看到这里，可以立马保存这张半价优惠券，直接微信扫码支付，这次派聪明 RAG 知识库的源码会采用邀请审核制，需要这个项目去冲 offer 的球友可以立马搞起来。
...
<u>派聪明通过集成 Apache Tika 文档解析、豆包 Embedding 向量模型、Elasticsearch 混合检索技术和 DeepSeek API，构建了一套完整的智能知识处理流水线。</u>
...
MinIO 的话，在处理文件的时候也经常用到， [<u>编程喵当时有讲到 </u>](https://www.yuque.com/itwanger/vn4p17/ta5vr1)，但技术派和 PmHub 中都没有应用，这次派聪明我们也一并补齐了。
...
目前，派聪明这个项目也收尾了，大家可以放心冲 😊。并且一次购买不需要额外付费，即可获取星球的所有付费资料，帮助你少走弯路，提高学习的效率。
