...
![](images/✅Docker部署派聪明（懒人福音）-493dc73278a3073e9b94573ae90ba0f0.png)

## 第一步、安装 Docker

Docker 官网： `https://www.docker.com/`

![](images/✅Docker部署派聪明（懒人福音）-7ca20506566aea730fa882ef7a1d5c45.png)
...
![](images/✅Docker部署派聪明（懒人福音）-c94a1e41e6a8005170f80fa532e1b6be.png)

### b.添加 docker 镜像源

![](images/✅Docker部署派聪明（懒人福音）-b492aa73643c7448b10762b95e6c9794.png)
...
![](images/✅Docker部署派聪明（懒人福音）-39ddb3b995a6ae984bdd30a1be6206ec.png)

代码仓库的获取方式，可以复制这个链接到浏览器的 URL 打开： `https://t.zsxq.com/XBc0a`

![](images/✅Docker部署派聪明（懒人福音）-082d3e60aef2eb45c56eb6496aaa55ea.png)
...
![](images/✅Docker部署派聪明（懒人福音）-5bfae9b8a9c029c2cd7ef11091c38ae1.png)

出现以下界面，就说明所有服务都部署完成了

![](images/✅Docker部署派聪明（懒人福音）-a78c40e7fecf0341585aad95ca7d6bd4.png)

这时候同样可以在 docker-desktop 中查看容器的运行状态

![](images/✅Docker部署派聪明（懒人福音）-8c2eb14c632b2f782011800f8aa9e4fe.png)

## 四、验货时间！确认服务正常运行

输入 `sudo docker ps` 查看容器运行状态：

![](images/✅Docker部署派聪明（懒人福音）-9cd099fe426e4fc331e1f917b0444bf0.png)

验证 **mysql**

![](images/✅Docker部署派聪明（懒人福音）-d35c917a9ba2e8ad4aacb591f09a30c1.png)

验证 **redis**

![](images/✅Docker部署派聪明（懒人福音）-cf02f5f2c66fcdbf1ca17797b423932c.png)

验证 **minio&#x20;**，直接在浏览器输入 [<u>http://localhost:19001/login </u>](http://localhost:19001/login)，输入账号密码验证

![](images/✅Docker部署派聪明（懒人福音）-ac2a3e569fdebfdcd0cda74294e95eea.png)

验证 **kafka&#x20;**&#x5728; docker 桌面端输入命令，查看主题列表 `kafka-topics.sh --list --bootstrap-server` `localhost:9092`

![](images/✅Docker部署派聪明（懒人福音）-c014606acb78577365caf9abf92cd46d.png)

验证 **ElasticSearch&#x20;**&#x6D4F;览器访问 [<u>http://localhost:9200/ </u>](http://localhost:9200/)，输入账号密码登录

![](<images/✅Docker部署派聪明（懒人福音）-8940a6d08e46242658fb1ad416c4c6df.png >)

![](images/✅Docker部署派聪明（懒人福音）-87e682caa657b19db8104e1228f0d7e1.png)

输入 [<u>http://localhost:9200/_cat/plugins?v </u>](http://localhost:9200/_cat/plugins?v)，验证分词器插件是否安装成功

![](images/✅Docker部署派聪明（懒人福音）-bec837b2f289db4d55e3bfab459e469a.png)

## 五、修改本地运行参数

最后修改 `application.yml` 相关参数，和 `docker-compose.yaml` 中的对应参数保持一致即可。

![](images/✅Docker部署派聪明（懒人福音）-ca238be67de48633a71790ce3f27f240.png)
