...
# docker-compose down
[+] Running 2/2
 ✔ Container qwen35-4b-qwen3.5-4b-1  Removed  3.4s
 ✔ Network qwen35-4b_default         Removed
# docker-compose up -d
[+] Running 1/2
 ⠋ Network qwen35-4b_default         Created  2.0s
 ✔ Container qwen35-4b-qwen3.5-4b-1  Started
```

注意，如果 GPU 机器没有 nvlink（通过 `nvidia-smi topo -m` 命令查询），建议关闭 P2P 和 IB，添加如下变量即可：
