...
但之前 Obsidian 有个问题——配置太复杂了。要装插件、要配同步、要学 Markdown 语法、要研究各种方法论（什么 Zettelkasten、PARA、MOC），光是折腾"怎么用"就能把人劝退。但现在不一样了。Claude Code 的生态起来之后，Obsidian 的使用门槛大幅降低了。 你不需要懂那些方法论，Claude Code 替你搞定。具体来说，现在有三个关键工具把 Obsidian 和 AI 打通了：
