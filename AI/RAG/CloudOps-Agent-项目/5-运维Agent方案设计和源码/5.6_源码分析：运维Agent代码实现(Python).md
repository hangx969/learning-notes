![](https://raw.githubusercontent.com/hangx969/upload-images-md/main/20260501134859164.png)

# 前言

关键代码： `app/agent/aiops/` 目录下的 `state.py` 、 `planner.py` 、 `executor.py` 、 `replanner.py` ，以及 `app/services/aiops_service.py` 。

![](https://raw.githubusercontent.com/hangx969/upload-images-md/main/20260501134902733.png)
...
![](https://raw.githubusercontent.com/hangx969/upload-images-md/main/20260501134905565.png)
...
![](https://raw.githubusercontent.com/hangx969/upload-images-md/main/20260501134908679.png)
