...
如果结构体的字段类型是: ==slice==，和 ==map== 的默认零值都是 nil ，即还没有分配空间。如果需要使用这样的字段，需要先make，才能使用：
...
**相关笔记：** [[go-基础-05-函数-包]] | [[go-基础-02-数组-切片-map]] | [[go-错误处理]] | [[go-web开发]] | [[云原生开发-基础]]
