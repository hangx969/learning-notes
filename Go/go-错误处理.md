...
> [!important] Go 错误处理哲学
> Go鼓励通过==返回值==显式传递和处理错误，而不是依赖异常（panic/recover）。只有在不可恢复的严重错误（如数组越界、除零、程序内部bug）时才用panic。
...
**相关笔记：** [[go-基础-05-函数-包]] | [[go-基础-03-变量-数据类型-运算]] | [[go-面向对象]] | [[go-web开发]]
