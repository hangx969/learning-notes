...
**推荐顺序：** [[go-基础-01-环境配置-基础|go-基础-01-环境配置-基础]] → [[Go/go-变量-数据类型-运算|go-变量-数据类型-运算]] → [[Go/go-分支-循环|go-分支-循环]] → [[Go/go-函数-包|go-函数-包]] → [[Go/go-数组-切片-map|go-数组-切片-map]] → [[Go/go-面向对象|go-面向对象]] → [[Go/go-错误处理|go-错误处理]] → [[Go/go-web开发|go-web开发]] → [[Go/云原生开发-基础|云原生开发-基础]]
