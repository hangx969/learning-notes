...
### 扩缩容（7 篇）
HPA-VPA、KEDA、Goldilocks、VPA Helm、[[Docker-Kubernetes/k8s-scaling/k8s成本优化方案-FinOps实战|K8s FinOps 成本优化]]、[[Docker-Kubernetes/k8s-scaling/KServe+KEDA实战-基于请求指标实现服务自动扩缩容|KServe + KEDA 请求指标扩缩容]]、[[Docker-Kubernetes/k8s-scaling/k8s-1.37原生HPA-Scale-to-Zero实战|K8s 1.37 原生 HPA Scale-to-Zero]]
...
- **云平台 K8s 托管服务：** [[Azure/2_AKS-basics|2_AKS-basics]]、[[Aliyun/计算/ECS|ECS]]
- **理论基础：** [[CloudComputing/深入剖析Kubernetes|深入剖析Kubernetes]]、[[CloudComputing/云原生|云原生]]
- **编程自动化：** [[Python/python-运维开发/python-kubernetes-module|python-kubernetes-module]]、[[Go/云原生开发-基础|云原生开发-基础]]
- **HPC 调度对比：** [[HPC/CentOS7-slurm23.02-二进制安装|CentOS7-slurm23.02-二进制安装]]
- **认证考试：** [[Docker-Kubernetes/CKA-CKS/CKA-备考|CKA-备考]]、[[Docker-Kubernetes/CKA-CKS/CKS-备考|CKS-备考]]
