...
| 搜索词 | 应定位到 |
|--------|----------|
| 负载均衡 | [[Aliyun/网络/负载均衡SLB]] |
| SLB / CLB / ALB / NLB | [[Aliyun/网络/负载均衡SLB]] |
| 对象存储 | [[Aliyun/存储/对象存储OSS]] |
| 弹性计算 | [[Aliyun/计算/ECS]] |
| 容器编排 | [[KnowledgeBase/concepts/Kubernetes]] |
| 服务发现 | [[Docker-Kubernetes/k8s-basic-resources/k8s基础-Service]] |
| 包管理器 | [[KnowledgeBase/concepts/Helm]] |
| 可观测性 / Observability | [[KnowledgeBase/concepts/Observability]] |
| 流量管理 | [[KnowledgeBase/concepts/Istio]] |
| GitOps | [[KnowledgeBase/concepts/ArgoCD]] |
