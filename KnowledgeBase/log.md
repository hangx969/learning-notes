...
## [2026-09-05] ingest | Codex Host 多厂商 Harness 接入

- 摄入原始来源 [[0raw/在 Codex 里随时切换不同厂家的 Harness]]；原文已为技术项目介绍，未修改 Raw Source。
- 新增 [[KnowledgeBase/sources/codex-host-harness-summary|来源摘要]]，记录 `BytePioneer-AI/codex-host` 的统一入口、Codex 交互继承与角色化协作主张，并标注为待验证。
- 更新 [[KnowledgeBase/entities/Codex|Codex]]、[[KnowledgeBase/maps/ai-workflow-map|AI 工作流专题地图]] 与 [[KnowledgeBase/INDEX|知识库目录]]。
