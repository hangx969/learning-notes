...
## 使用场景
- 应用打包分发：将 K8s 资源模板化为 Chart，版本化管理
- 环境差异化配置：通过 values.yaml 区分 dev/staging/prod
- 第三方中间件部署：一键部署 Prometheus、Redis、Kafka 等开源组件
...
- [[Docker-Kubernetes/k8s-scaling/k8s-HPA-VPA#七、部署 VPA|Helm 部署 VPA]]
