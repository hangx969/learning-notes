...
sources:
  ...
  - "[[AI/ClaudeCode/planning-with-files-AI项目规划Skill]]"
---
...
- [[AI/ClaudeCode/code-review-graph-本地代码知识图谱]]：本地代码知识图谱工具——Tree-sitter AST 解析→SQLite 图谱→MCP 接入 Claude Code，blast-radius 影响范围分析，2900 文件增量索引 2 秒
- [[AI/ClaudeCode/planning-with-files-AI项目规划Skill]]：Planning with Files（21.4K Star）——3 个 Markdown 文件（task_plan/findings/progress）实现文件化规划+外置记忆+错误自动记录，任务成功率 6.7%→96.7%
