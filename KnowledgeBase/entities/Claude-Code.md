...
- [[AI/Obsidian/obsidian-claude-搭建个人知识库]]：Obsidian 集成方案（Claudian + Skills + MCP）
- [[AI/Obsidian/obsidian-claude-code-AI知识管家]]：为什么 Obsidian+Claude Code 是最优解（Markdown 母语论证、三大项目殊途同归）、30 分钟上手路径
...
- [[KnowledgeBase/sources/obsidian-claude-搭建个人知识库-summary|知识库搭建摘要]]：Claudian/Skills/MCP 三种集成方式
